 ...
 if(document.getElementById("mainName").value != "" && document.getElementById("mainDesc").value != "")
  {
    ...
    saveToLocalStorage(name, description, schedule, uniqKey);
...
function saveToLocalStorage(Name, Description, Schedule, key){
  try{
    if (typeof key != 'undefined' && typeof Name != 'undefined'&& typeof Description != 'undefined' && typeof Schedule != 'undefined'){
      var value = {name : Name,
